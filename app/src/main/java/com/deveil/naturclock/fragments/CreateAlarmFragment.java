package com.deveil.naturclock.fragments;
...
import com.deveil.naturclock.databinding.FragmentCreateAlarmBinding;
import com.deveil.naturclock.model.Alarm;
import com.deveil.naturclock.util.DayUtil;
import com.deveil.naturclock.util.TimePickerUtil;
import com.deveil.naturclock.viewmodel.CreateAlarmViewModel;
...
public class CreateAlarmFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentCreateAlarmBinding.fragmentCreatealarmTimePickerLayout.setText(hour + ":" + minute);
...
*/
        ...
        fragmentCreateAlarmBinding.fragmentCreatealarmTimePickerLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        ...
                        fragmentCreateAlarmBinding.fragmentCreatealarmTimePickerLayout.setText(selectedHour + ":" + selectedMinute);
                    }
                }, hour, minute, true);
